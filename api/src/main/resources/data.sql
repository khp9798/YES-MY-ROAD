...
SELECT '강릉시', region_id
FROM region
WHERE region_name = '강원특별자치도';
INSERT IGNORE INTO region (region_name, parent_region_id)
SELECT '고성군', region_id
FROM region
WHERE region_name = '강원특별자치도';
INSERT IGNORE INTO region (region_name, parent_region_id)
SELECT '동해시', region_id
FROM region
WHERE region_name = '강원특별자치도';
INSERT IGNORE INTO region (region_name, parent_region_id)
SELECT '삼척시', region_id
FROM region
WHERE region_name = '강원특별자치도';
INSERT IGNORE INTO region (region_name, parent_region_id)
SELECT '속초시', region_id
FROM region
WHERE region_name = '강원특별자치도';
INSERT IGNORE INTO region (region_name, parent_region_id)
SELECT '양구군', region_id
FROM region
WHERE region_name = '강원특별자치도';
INSERT IGNORE INTO region (region_name, parent_region_id)
SELECT '양양군', region_id
FROM region
WHERE region_name = '강원특별자치도';
INSERT IGNORE INTO region (region_name, parent_region_id)
SELECT '영월군', region_id
FROM region
WHERE region_name = '강원특별자치도';
INSERT IGNORE INTO region (region_name, parent_region_id)
SELECT '원주시', region_id
FROM region
WHERE region_name = '강원특별자치도';
INSERT IGNORE INTO region (region_name, parent_region_id)
SELECT '인제군', region_id
FROM region
WHERE region_name = '강원특별자치도';
INSERT IGNORE INTO region (region_name, parent_region_id)
SELECT '정선군', region_id
FROM region
WHERE region_name = '강원특별자치도';
INSERT IGNORE INTO region (region_name, parent_region_id)
SELECT '철원군', region_id
FROM region
WHERE region_name = '강원특별자치도';
INSERT IGNORE INTO region (region_name, parent_region_id)
SELECT '춘천시', region_id
FROM region
WHERE region_name = '강원특별자치도';
INSERT IGNORE INTO region (region_name, parent_region_id)
SELECT '태백시', region_id
FROM region
WHERE region_name = '강원특별자치도';
INSERT IGNORE INTO region (region_name, parent_region_id)
SELECT '평창군', region_id
FROM region
WHERE region_name = '강원특별자치도';
INSERT IGNORE INTO region (region_name, parent_region_id)
SELECT '홍천군', region_id
FROM region
WHERE region_name = '강원특별자치도';
INSERT IGNORE INTO region (region_name, parent_region_id)
SELECT '화천군', region_id
FROM region
WHERE region_name = '강원특별자치도';
INSERT IGNORE INTO region (region_name, parent_region_id)
SELECT '횡성군', region_id
FROM region
WHERE region_name = '강원특별자치도';
INSERT IGNORE INTO region (region_name, parent_region_id)
SELECT '가평군', region_id
FROM region
WHERE region_name = '경기도';
INSERT IGNORE INTO region (region_name, parent_region_id)
SELECT '고양시', region_id
FROM region
WHERE region_name = '경기도';
INSERT IGNORE INTO region (region_name, parent_region_id)
SELECT '과천시', region_id
FROM region
WHERE region_name = '경기도';
INSERT IGNORE INTO region (region_name, parent_region_id)
SELECT '광명시', region_id
FROM region
WHERE region_name = '경기도';
INSERT IGNORE INTO region (region_name, parent_region_id)
SELECT '광주시', region_id
FROM region
WHERE region_name = '경기도';
INSERT IGNORE INTO region (region_name, parent_region_id)
SELECT '구리시', region_id
FROM region
WHERE region_name = '경기도';
INSERT IGNORE INTO region (region_name, parent_region_id)
