...
//     setFormData({
//       ...formData,
//       [id]: id === 'region' ? parseInt(value) || 0 : value // region은 숫자로 변환
//     })
//   }
...
//       } catch (err) {
//         // 에러는 store에서 처리되므로 여기서는 추가 처리 안함
//       }
//     }
//   }
...
const Login: React.FC = () => {
  ...
  console.log('[컴포넌트 마운트] 스토어 상태:', { isLoading, error, isAuthenticated })
